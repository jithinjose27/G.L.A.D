...
def generate_launch_description():
    ...
    glad_rplidar_launch = GroupAction(
        [
            LogInfo(msg="[GLAD Final Tour] 1. Activating RPLidar Sensor Driver..."),
    ...
    glad_laser_filter_launch = GroupAction(
        [
            LogInfo(msg="[GLAD Final Tour] 2. Initializing Laser Filter Node..."),
    ...
    glad_imu_publisher_launch = GroupAction(
        [
            LogInfo(msg="[GLAD Final Tour] 3. Activating IMU Hardware Driver..."),
    ...
    glad_imu_filter_launch = GroupAction(
        [
            LogInfo(msg="[GLAD Final Tour] 4. Booting IMU Madgwick Filter..."),
    ...
    rf2o_laser_odometry_launch = GroupAction(
        [
            LogInfo(msg="[GLAD Final Tour] 5. Starting rf2o Laser Odometry..."),
    ...
    glad_ekf_launch = GroupAction(
        [
            LogInfo(msg="[GLAD Final Tour] 6. Deploying Extended Kalman Filter..."),
    ...
    slam_toolbox_launch = GroupAction(
        [
            LogInfo(msg="[GLAD Final Tour] 7. Launching SLAM Toolbox..."),
    ...
    static_tf = GroupAction(
        [
            LogInfo(msg="[GLAD Final Tour] 8. Mounting Static Transforms..."),
    ...
    teleop_launch = GroupAction(
        [
            LogInfo(msg="[GLAD Final Tour] 9. Activating Teleop and Motion Control..."),
    ...
    glad_nav2_launch = GroupAction(
        [
            LogInfo(msg="[GLAD Final Tour] 10. Launching Nav2 Stack..."),
            _include(
                "glad_navigation",
                "glad_nav2_launch.py",
    ...
    glad_tour_launch = GroupAction(
        [
            LogInfo(msg="[GLAD Final Tour] 11. Starting Autonomous Tour..."),
            _include("glad_tour", "glad_tour_launch.py", base_args),
        ]
    )
    ...
    return LaunchDescription(
        args
        + [
            LogInfo(msg="========== GLAD FINAL TOUR LAUNCHED =========="),
            static_tf,
            glad_rplidar_launch,
            ...
            TimerAction(period=10.0, actions=[glad_tour_launch]),
        ]
    )
