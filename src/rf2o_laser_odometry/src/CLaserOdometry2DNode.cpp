...
// 1. POSE COVARIANCE
  // A1M8: Good X/Y, Decent Yaw, Unknown Z/Roll/Pitch
  odom.pose.covariance[0]  = 0.05;    // x variance
  odom.pose.covariance[7]  = 0.05;    // y variance
  odom.pose.covariance[14] = 99999.0; // z variance (Planar lidar doesn't know Z)
  odom.pose.covariance[21] = 99999.0; // roll variance
  odom.pose.covariance[28] = 99999.0; // pitch variance
  odom.pose.covariance[35] = 0.1;     // yaw variance

  // 2. TWIST COVARIANCE (Velocity)
  // A1M8: Excellent Linear Velocity, Weak Angular Velocity (compared to IMU)
  odom.twist.covariance[0]  = 0.02;    // vx variance (TRUST THIS!)
  odom.twist.covariance[7]  = 0.02;    // vy variance (TRUST THIS!)
  odom.twist.covariance[14] = 99999.0; // vz variance
  odom.twist.covariance[21] = 99999.0; // vroll variance
  odom.twist.covariance[28] = 99999.0; // vpitch variance
  odom.twist.covariance[35] = 0.5;     // vyaw variance (Set HIGH so EKF prefers IMU)
  //set the velocity
